...
Riverbraid-Action-Gold is a canonical Gold module surface within Riverbraid.

This repository represents the Action domain inside the current Evaluation Kit registry. It supports action boundary review and execution gating material as part of the public Riverbraid verification constellation while Riverbraid-Core remains the normative source for protocol semantics.
